...
interface ClinicSetHoursProps {
  isOpen: boolean;
  onClose: () => void;
}

const ClinicSetHours: React.FC<ClinicSetHoursProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-full max-w-[40rem] md:max-w-[40rem] p-4 md:p-6 mx-3">
        {/* Modal Header */}
        <h3 className="text-xl font-semibold mb-4 text-gray-600">Clinic Business Hours</h3>
        <hr className="mb-6" /> 
