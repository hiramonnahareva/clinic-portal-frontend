...
const Footer = () => {
  return (
    <div className="bg-white shadow-md md:z-50 z-0 flex flex-col sm:flex-row items-center justify-between p-2 border-t border-gray-300 w-full fixed bottom-0 left-0">
